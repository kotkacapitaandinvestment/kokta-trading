          ...
          <div className="h-64 w-full">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={stats.models} layout="vertical" margin={{ top: 0, right: 16, left: 8, bottom: 0 }}>
                ...
                <YAxis type="category" dataKey="model" width={200} tickLine={false} axisLine={false} tick={{ fontSize: 12, fill: CHART_COLORS.tick.light }} />
                <Tooltip contentStyle={{ borderRadius: 12, border: `1px solid ${CHART_COLORS.grid.light}`, fontSize: 12 }} />
                <Bar dataKey="requests" radius={[0, 6, 6, 0]} fill={CHART_COLORS.accent} />
              </BarChart>
            </ResponsiveContainer>
          </div>
        </CardBody>
